...
public class Bin {
	...
	// other ways to store type of bin
	// BinType binType; // todo: use this
	// boolean estCompost, estRecyclage, estOrdures;
	...
	ArrayList<String> compositionHist = new ArrayList<String>(); // 
	...
	public Bin(String qrCode, String name, String type, String address) {
		...
		//? set other bins stats placeholder info here
	...
	public void updateStatus() {
		...
		currentComposition = (Math.random() * 100 + "% plastic, " + Math.random() * 100 + "% paper, etc");
