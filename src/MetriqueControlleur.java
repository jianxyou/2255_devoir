...
import java.util.*;
/**
 * genere les metrique pour le resident et pour la ville
 * @author admin
 *
 */
...
/**
   ...
   * Cr: Cout du recyclage
	...
	*/
    ...
    /**
     * clacule la participation au composte
     * @param tNc
     * @param Ec
     */
    ...
    /**
     * calcule le niveau de participation 
     * @param tNc prend en parametre le tableau d'usage des trois categorie de composte 
     * @param Ec et le tableau de  niveau de remplissage de trois categorie de composte
     * @return
     */
    ...
    /**
     * participation au recyclage
     * @param tNr prend en parapemtre un tableau de niveau de remplissage de trois categorie de recyclage
     * @param Er un tableau de dimension 3 contenant l'usage des trois categorie de recyclage
     */
   ...
   /**
    * calcule Uc retourne le niveau de participation au recyclage
    * @param tNr prend en parametre le tableau d'usage des trois categorie de recyclage 
    * @param Er tableau de niveau de remplissage de trois categorie de recyclage
    * @return
    */
    ...
    /**
     * calcule le score Ecolo :
     * @param Ur usage de recyclage
     * @param Uc usage de composte
     * @param Nr niveau recuclage
     * @param Nc niveau de composte
     * @param No niveau ordure
     * @param Pr poid de recyclage 
     * @param Pc poid de composte
     * @param Po point d'ordure
     * @param PNUI
     */
    ...
    /**
     * calcule le porportion de niveua de remplissage
     * @param PNr
     * @param PNc
     * @param PNo
     */
    ...
    /**
     * calcule le erreur de triage de recyclage
     * @param Nr
     * @param tNr
     */
